"""
Amaç :
  - Sentetik veri seti oluşturarak K means ve Agglomerative Clustering algoritmasını uygula
  - K means küme merkezlerinin ( centroid ) nasıl oluştuğunu görselleştir
  - Dendrogram ile birleştirme yapısını incele
...
plt.figure()
plt.scatter(X[:,0], X[:,1], s=50,cmap="viridis",c=labels,alpha=0.7,edgecolors="k")
#küme merkezleri
