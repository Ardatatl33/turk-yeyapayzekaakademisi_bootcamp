...
Amaç : 
    ...
    3. Lasso ile feature selection yapalım
  
Adımlar: 
    1. Sentetik veri seti oluştur
    2. Oluşturulan sentetik veriyi görselleştir
    3. Veriyi eğitim ve test olarak ayır
    4. Doğrusal polinomal, lasso ve ridge modellerini oluştur
    5. Modelleri eğit ve tahmin yap
    6. Modellerin performansını karşılaştır
    7. Lasso ile feature selection
...
y = ( #x1 ve x2 önemli features x3 ve x4 önemisz features
  4
  + 2.5 * x1
  + 3.2 * x2
  + 1.8 * x3
...
# oluşturulan senteteik veriyi görselleştir
